...
class WingsSharedComponent {
    ...
    public var angleR(get,never):Float; inline function get_angleR() return Math.clamp(inputY,-0.2,1);
    public var angleL(get,never):Float; inline function get_angleL() return -Math.clamp(inputY,-0.2,1);
    ...
    public var aperture(get,never):Float; inline function get_aperture() return Math.clamp(inputY,0,1);
